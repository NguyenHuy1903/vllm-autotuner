/**
 * App.jsx — Layout chính của vLLM Auto-Tuner Dashboard.
 *
 * Layout:
 *   Left sidebar: ModelSelector + GPUSelector + ConfigPanel
 *   Main area: Dashboard3D
 *   Bottom bar: Sweep progress + real-time log stream
 */
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", background: "#f9fafb", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <span style={{
            fontFamily: "monospace", fontSize: 11, fontWeight: 700, color: "#16a34a",
            background: "#dcfce7", padding: "3px 9px", borderRadius: 2, letterSpacing: "0.1em",
          }}>
            vLLM AUTO-TUNER
          </span>
          <span style={{ fontSize: 12, color: "#6b7280" }}>
            3D Benchmark Dashboard · 8× H100 80GB
          </span>
        </div>
        <div style={{ display: "flex", gap: 8 }}>
          {selectedModel && (
            <button
              onClick={() => exportExcel(selectedModel)}
              style={{ padding: "5px 12px", fontSize: 11, fontWeight: 600, background: "#f3f4f6", border: "1px solid #d1d5db", borderRadius: 3, cursor: "pointer" }}
            >
              📊 Xuất Excel
            </button>
          )}
